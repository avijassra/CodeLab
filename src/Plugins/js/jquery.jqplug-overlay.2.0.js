...
overlayCore.modalCont = '<div id="{0}" class="ovrly-bg" style="background-color:#000; z-index: {1};" ></div>';
// external overlay ajax events
overlayCore.ajaxEventsNamespace = "ovrlyEvent";
// z-index of the first overlay
overlayCore.zIndex = 1001;
...
JqPlug.PopupContentView = function() {
	var _this = this,
		_data
		_onOpen,
		_onBeforeClose,
...
JqPlug.PopupView.prototype = {
	BackgroundLayer: function() {
		if(!_this._$backgroundLayer) {
			_this._$backgroundLayer = $.stringFormat(overlayCore.modalCont, [_this._id, overlayCore.zIndex])
		}
		return _this._$backgroundLayer
	};
};

JqPlug.Overlay = function() {
	// modal container html
